...
while (true) {
    ...
    // live partial data feedback (optional debug)
    console.log("streaming chunk:", receivedText);
}

// Convert final streamed text to quiz object
currentQuiz = parseQuiz(receivedText, topic);

...
# ------ QUIZ ------
# ------ QUIZ (STREAMING, NO TIMEOUT) ------
from flask import Response
import json

def stream_quiz(prompt):
    payload = {
        "model": "phi3:mini",
        "prompt": prompt,
        "stream": True
    ...
    with requests.post(f"{OLLAMA_HOST}/api/generate", json=payload, stream=True) as r:
...
"""
    ...
    return Response(stream_quiz(prompt), mimetype="text/plain")

...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayQuizQuestion() {
        ...
        quizContainer.innerHTML = `
            <div class="quiz-question">
                ...
                <div class="quiz-navigation">
                    ...
                    <button class="btn btn-ghost" id="nextQuizQuestion" ${currentQuizQuestionIndex === currentQuiz.questions.length - 1 ? 'disabled' : ''}>
                        Next
                    </button>
                </div>
            </div>
        ...
        // Show results if we're at the end and all questions are answered
        if (currentQuizQuestionIndex === currentQuiz.questions.length - 1 && userQuizAnswers.length === currentQuiz.questions.length) {
            showQuizResults();
        }
    }
    ...
    function showNextQuizQuestion() {
        if (currentQuizQuestionIndex < currentQuiz.questions.length - 1) {
            currentQuizQuestionIndex++;
            displayQuizQuestion();
        } else if (userQuizAnswers.length === currentQuiz.questions.length) {
            showQuizResults();
        }
    }
